...
description: Transform one or more user-supplied photos into a source-faithful Y2K or millennium-futurist collage poster by extracting recognizable people, objects, props, and detail crops; constructing a specific imagined future through digital technology, editorial space, material language, and emotional tension; arranging source elements through repetition, scale contrast, layered composition, and retro-digital framing; and unifying the result with one automatically selected primary style plus at most one supporting style drawn from Pop Scrapbook, Webcore Desktop, Punk Halftone, Liquid Chrome Futurism, and Techno Pop Campaign. Use for Y2K collage, millennium pop, idol scrapbook, webcore, old-internet, retro desktop, cyber-zine, halftone, grunge, liquid-chrome, consumer-tech campaign, gadget-world, or game-cover poster requests.
---
...
- **Techno pop campaign:** turn the source subject into the star of an imagined turn-of-the-millennium consumer-tech campaign. Build the spatial stage from oversized gadgets, product shells, screens, controls, aquariums, speakers, cameras, consoles, or other source-responsive devices rather than treating them as detached stickers. Combine one clear promotional hero with smaller repeated portraits, a dominant saturated product color, synthetic plastic or translucent surfaces, hard flash, deliberately imperfect early-digital compositing, and exaggerated game-logo or product-mark typography. Stylize the hero through heightened facial contrast, more saturated skin and makeup color, slightly blown highlights, crisp dark features, and restrained early-digital sharpening while preserving the source-specific face, hair, expression, clothing, and pose. Do not leave the portrait visually untouched, but do not replace it with an illustrated, plastic, or newly invented face; the treatment must intensify the source identity rather than overwrite it.
