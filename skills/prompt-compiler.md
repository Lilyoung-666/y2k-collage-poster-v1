...
- If neither a suitable host tool nor a configured Provider exists, return a generation handoff instead of claiming success. Include the compiled prompt, required reference-image roles, canvas ratio, and requested output format.
